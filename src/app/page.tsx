...
const STORAGE_KEY = 'guild_assessment_result'
...
export default function Home() {
  ...
  // On mount: if a previous result is stored, go straight to results
  // and fetch a fresh benchmark so peer data is always up to date.
  useEffect(() => {
  ...
  async function submitToApi(payload: SubmitPayload) {
    ...
    try {
      ...
      // Persist result so the user can return and see updated peer data
